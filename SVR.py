...
# np.savetxt('SVR/y_train.csv', y_train, delimiter=',')
# np.savetxt('SVR/y_train_pred.csv', y_train_pred, delimiter=',')
# np.savetxt('SVR/y_test.csv', y_test, delimiter=',')
# np.savetxt('SVR/y_test_pred.csv', y_test_pred, delimiter=',')
...
np.savetxt('SVR/Total-prediction-SVR.csv', prediction, delimiter=",")
