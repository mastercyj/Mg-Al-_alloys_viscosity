...
pre = np.loadtxt('../Total/sanyuan-zibian.csv', delimiter=",", dtype="float")
X = data_train[..., 0:6]
y = data_train[..., 6]
...
# np.savetxt('RFR/y_train.csv', y_train, delimiter=',')
# np.savetxt('RFR/y_train_pred.csv', y_train_pred, delimiter=',')
# np.savetxt('RFR/y_test.csv', y_test, delimiter=',')
# np.savetxt('RFR/y_test_pred.csv', y_test_pred, delimiter=',')
...
np.savetxt('RFR/sanyuan-zibian-prediction.csv', prediction, delimiter=",")
